...
//	public static final Color ROUTE_BORDER_FONT_COLOR=new Color(96,4,122);
	public static final Color TRAFFIC_COMP_BORDER_COLOR=new Color(0,0,0);
	public static final Color TRAFFIC_COMP_BORDER_FONT_COLOR=new Color(0,0,0);
	...
	public static final Color VEHICLE_TYPE_BORDER_COLOR=new Color(180,180,180);
	public static final Color VEHICLE_TYPE_BORDER_FONT_COLOR=new Color(180,180,180);
